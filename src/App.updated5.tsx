      ...
      <div className="login-container">
        ...
        {registrationSuccessful ? (
          <div className="registration-success">
            <p className="success-message">You will receive the AIDX token on <span className="highlighted-address">{truncateAddress(finalEvmAddressForAirdrop)}</span></p>
            <p className="airdrop-address">✨ You're successfully registered for the airdrop! 🥳</p>
          </div>
        ) : canRegister() && (
