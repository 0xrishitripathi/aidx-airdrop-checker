      ...
      <div className="login-container">
        ...
        {registrationSuccessful ? (
          <div className="registration-success">
            <p className="success-message">✨ You're successfully registered for the airdrop! 🥳</p>
            <p className="airdrop-address">You will receive the AIDX token on <span className="highlighted-address">{truncateAddress(finalEvmAddressForAirdrop)}</span></p>
          </div>
        ) : canRegister() && (
